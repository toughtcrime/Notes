...
public class NoteService : INoteService
{
    ...
    {
        Response<User> result = await _userService.GetUserByUserNameAsync(username);
        if(result.StatusCode == HttpStatusCode.NotFound)
        {
            //Returning http response
            return new Response<Note> { StatusCode = HttpStatusCode.NotFound, ErrorMessage = "User was not found"}; 
        }
